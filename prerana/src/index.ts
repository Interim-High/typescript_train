import FunctionQuestion from "./Functions";
import genericExample from "./Generics";
import interfaceExample from "./interface";
import InterfaceQuestions from "./interfaceQuestion";
import ObjectExample from "./object";
import Questions from "./Questions";
import RefiningTypesExample from "./RefiningTypes";
import TypeExample from "./type";
import UnionExample, { Example2 } from "./UnionTypes";
